  ...
  return (
    <>
     ...
     <Navbar expand="md" style={ { backgroundColor: '#002F6C' } } variant="dark" className="px-3 shadow-sm"> 
        ...
        <Container fluid>
            ...
            <img src="/uniesp.jpg" alt="Uniesp Logo" width={60} height={60} className="me-6 rounded"></img>
    ...
    <Offcanvas show={show} onHide={handleClose}> 
      ...
      <Offcanvas.Body>
        ...
        <Nav className="flex-column"> {/* Cada item de menu fecha o Offcanvas ao ser clicado */}
